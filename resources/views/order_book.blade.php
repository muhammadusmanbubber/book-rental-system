            ...
            <div class="col-lg-12" style="padding-left:30%; padding-right:30%;">
                <form action="{{url('rented_book',$show_details->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="" class="form-control" name="" value="{{ $show_details->id }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="Book_Name">Book Name</label>
                        <input type="text" class="form-control" name="book_name" value="{{ $show_details->book_name }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="email">Auther Name</label>
                        <input type="text" class="form-control" name="auther_name" value="{{ $show_details->auther_name }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="pages">Pages</label>
                        <input type="text" class="form-control" name="pages" value="{{ $show_details->pages }}" disabled>
                    </div>
